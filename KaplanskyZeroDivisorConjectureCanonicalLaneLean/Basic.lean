/-!
# kaplansky-zero-divisor-conjecture-canonical-lane Lean migration boundary
...
`KaplanskyZeroDivisorConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "kaplansky-zero-divisor-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/kaplansky-zero-divisor-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Kaplansky's zero-divisor conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["algebra", "mathematical-proof", "reproducibility", "group-rings", "kaplansky-zero-divisor-conjecture", "noncommutative-algebra", "torsion-free-groups", "canonical-lane", "local-to-global", "manifold-constrained"]
